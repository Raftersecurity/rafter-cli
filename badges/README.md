...
For CI status badges that reflect actual scan results, use your CI provider's native badge (e.g., GitHub Actions workflow status badge) on the workflow that runs `rafter secrets`.
