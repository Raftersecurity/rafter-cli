...
class TestUnavailable:
    ...
    def test_deep_requested_but_missing_exits_2(self, tmp_path, monkeypatch):
        ...
        # Install hint surfaced. CliRunner mixes stderr into output, so it lands
        # in result.output (result.stderr is not separately captured here).
        assert "cisco-ai-skill-scanner" in result.output
