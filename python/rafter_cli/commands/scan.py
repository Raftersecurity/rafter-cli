...
def scan_default(
    ...
    mode: str = typer.Option("fast", "--mode", "-m", help="scan mode: fast | plus. plus is a strict SUPERSET of fast (same SAST+SCA+secrets pass + agentic deep-dive) — pick one, do NOT run both. Prefer plus for security-relevant scans; fast for cheap iteration."),
