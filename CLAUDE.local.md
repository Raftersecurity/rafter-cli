...
**YOU ARE IN: `raftercli/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/raftercli/` (rig root) or other directories
...
**Your mail address:** `raftercli/polecats/obsidian`
**Your rig:** raftercli
**Your Witness:** `raftercli/witness`
...
| Ask Witness for help | `gt mail send raftercli/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`raftercli/witness`) when:
...
```bash
gt mail send raftercli/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
