...
<p>
  ...
  <a href="#supported-platforms"><img alt="Hermes supported" src="https://img.shields.io/badge/Hermes-supported-7e3af2?style=flat&labelColor=141413"></a>
</p>
...
| Hermes | MCP + Skills + Instructions | `~/.hermes` | `~/.hermes/config.yaml`, `~/.hermes/skills/`, `~/.hermes/SOUL.md` |
