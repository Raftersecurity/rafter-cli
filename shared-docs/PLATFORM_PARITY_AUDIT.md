...
Outstanding rf-cia work after this PR: rf-acz0 (Continue rules), rf-044o (Gemini re-verify), rf-ovql (Codex schema), rf-65zg (`agent verify` enhancements), rf-o329 (onboarding doc), rf-0lig (OpenClaw activity check).
